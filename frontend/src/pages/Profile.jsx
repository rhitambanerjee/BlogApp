...
const fetchProfile=async ()=>{
  try{
     const res=await axios.get("https://blogapp-1-11u7.onrender.com/api/users/"+user._id)
...
const handleUserUpdate=async ()=>{
  setUpdated(false)
  try{
    const res=await axios.put("https://blogapp-1-11u7.onrender.com/api/users/"+user._id,{username,email,password},{withCredentials:true})
...
const handleUserDelete=async()=>{
  try{
    const res=await axios.delete("https://blogapp-1-11u7.onrender.com/api/users/"+user._id,{withCredentials:true})
    setUser(null)
    navigate("/")
    // console.log(res.data)
